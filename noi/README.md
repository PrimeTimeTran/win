...
**Noi** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **PrimeTimeTran**

Time spent: **20** hours

URL: **https://salty-brushlands-65165.herokuapp.com**
...
* [x] Clicking on "new message" takes the user to a page where they can write a new message. The recipient field should be a dropdown, where the options are names from the user's friends.
